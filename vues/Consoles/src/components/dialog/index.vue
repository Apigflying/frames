<template>
  <el-dialog :title="title" :visible.sync="isDialogShow" width="50%" :before-close="closeDialog">
...
*/
export default {
  props: ['title', 'dataFormat', 'dataTable', 'pagination'],
  data () {
    return {
      isDialogShow: false,
  ...
  methods: {
    ...
    //显示弹窗
    showDailog (tableData) {
      if (!this.isDialogShow) {
        this.isDialogShow = true;
      }
      this.dialogPages.currentPage = 1;
